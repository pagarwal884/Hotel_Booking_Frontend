...
import heroImage from "../assets/heroImage.png"; // Adjust the path
...
const Hero = () => {
    return (
        ...
        >
            ...
            <form className='bg-black/55 text-white rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-8'>
