   ...
   useEffect(() => {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            <div
                className={`fixed top-0 left-0 w-full h-screen bg-white text-base flex flex-col items-center justify-center gap-6 font-medium text-gray-800 transition-all duration-500 md:hidden ${isMenuOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                <button
                ...
                <button className="border px-4 py-1 text-sm font-light rounded-full" onClick={() => navigate('/owner')}>
                    Dashboard
                </button>
